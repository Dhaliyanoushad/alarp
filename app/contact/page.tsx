        ...
        <div className="max-w-[1600px] mx-auto px-8">
          <div className="flex flex-col lg:flex-row gap-24">
            ...
            <div className="lg:w-1/3">
              <h1 className="text-slate-900 text-5xl md:text-6xl font-black mb-8 leading-tight">Connect with a <br /><span className="text-[#E30613]">Consultant</span></h1>
              ...
              <div className="space-y-8">
                <div className="flex gap-6 items-center">
                  <div className="w-14 h-14 bg-white rounded-full flex items-center justify-center text-[#E30613] shadow-sm">
                    <Phone size={24} />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Call Us 24/7</p>
                    <p className="text-xl font-bold text-slate-900">1300 761 935</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-slate-900">advisory@alarpsafety.com.au</p>
                  </div>
                </div>
                ...
                <div className="flex gap-6 items-center">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-slate-900">Sydney / Melbourne / Brisbane</p>
                  </div>
                </div>
              </div>
