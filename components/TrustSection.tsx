  ...
  return (
    <section className="bg-slate-900 py-20 border-y border-slate-800">
      <div className="max-w-[1600px] mx-auto px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 md:gap-24 opacity-30 grayscale hover:grayscale-0 transition-all duration-700 font-sans">
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-[10px] font-bold tracking-tight">9001:2015</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-[10px] font-bold tracking-tight">SYSTEMS</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-[10px] font-bold tracking-tight">4801</span>
          </div>
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-white text-[10px] font-bold tracking-tight">CERTIFIED</span>
          </div>
        </div>
      </div>
    </section>
