...
export default function CTASection({ 
  ...
  return (
    <section className={`${isDark ? 'bg-slate-950 text-white' : 'bg-slate-50 text-slate-900'} py-24 relative overflow-hidden font-sans`}>
      {/* Decorative accent */}
      <div className="absolute top-0 right-0 w-1/3 h-full bg-red/5 -skew-x-12 translate-x-1/2" />
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link 
            href="/contact" 
            className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-full font-bold text-lg shadow-xl shadow-blue-900/20 transition-all flex items-center gap-3"
          >
